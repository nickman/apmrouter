...
public interface RouteDestination<T extends Routable> {
	...
	/**
	 * Callback from the {@link PatternRouter} that this destination was registered with 
	 * @param router the {@link PatternRouter} that this destination was registered with 
	 */
	public void onRegistered(PatternRouter<T> router);
}
