 ...
 */
public class HostTrigger extends AbstractTrigger implements HostTriggerMBean {
	
	/**
	 * Creates a new HostTrigger
	 */
	public HostTrigger() {
		super(new MBeanNotificationInfo(new String[]{NEW_HOST}, Notification.class.getName(), "A new host registration event"));
	}
