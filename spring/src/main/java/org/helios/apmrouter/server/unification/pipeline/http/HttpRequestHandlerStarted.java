...
/**
 * <p>Title: HttpRequestHandlerStarted</p>
 * <p>Description: A Spring app event published when an {@link HttpRequestHandler} starts</p> 
 * <p>Company: Helios Development Group LLC</p>
 * @author Whitehead (nwhitehead AT heliosdev DOT org)
 * <p><code>org.helios.apmrouter.server.unification.pipeline.http.HttpRequestHandlerStarted</code></p>
 */
public class HttpRequestHandlerStarted extends ApplicationEvent {
	/**  */
	private static final long serialVersionUID = 5709191202476835486L;
	/** The name of the bean */
	protected final String beanName;
	
	/**
	 * Creates a new HttpRequestHandlerStarted
	 * @param source The {@link HttpRequestHandler} that started
	 * @param beanName The name of the bean
	 */
	public HttpRequestHandlerStarted(HttpRequestHandler source, String beanName) {
		super(source);
