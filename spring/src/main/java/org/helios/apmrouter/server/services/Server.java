...
import org.helios.apmrouter.server.services.handlergroups.fileserver.HttpStaticFileServerHandler;
 ...
 * <p><code>org.helios.apmrouter.server.services.Server</code></p>
 */
public class Server {
	/** Static class logger */
