 ...
 * <p>Description: Defines a service that handles JSON requests for data services.</p> 
 * <p>Company: Helios Development Group LLC</p>
 * @author Whitehead (nwhitehead AT heliosdev DOT org)
 * <p><code>org.helios.apmrouter.dataservice.json.JSONDataService</code></p>
 */

public interface JSONDataService {
	/**
	 * Processes a request from a JSON data services client
