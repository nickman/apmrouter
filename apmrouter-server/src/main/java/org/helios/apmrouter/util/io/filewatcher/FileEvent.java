 ...
 * <p><code>org.helios.apmrouter.util.io.filewatcher.FileEvent</code></p>
 */
public class FileEvent implements Delayed {
	/** The filename for which a change was noticed */
	protected final String fileName;
	/** The directory for which a change was noticed */
	protected final Path watchDir;
	...
	public FileEvent(String fileName, Kind<Path> eventType) {
		...
		watchDir = f.getParentFile().toPath();
	...
	/**
	 * Returns the watched directory of this file event
	 * @return the watched directory of this file event
	 */
