...
if(sender.subListeners.isEmpty()) {
    sender.subscribeMetricURI("local/hserval/APMRouterServer/platform=APMRouter/component=MetricURISubscriptionService/category=RealTimeDataEvents", listener);
