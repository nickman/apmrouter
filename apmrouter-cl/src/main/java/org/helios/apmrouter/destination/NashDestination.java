 ...
 * <p><code>org.helios.apmrouter.destination.NashDestination</code></p>
 */

public class NashDestination extends BaseDestination implements NashRequestHandler {
	...
	/**
	 * Returns a set of the current subscribers
	 * @return a set of the current subscribers
	 */
